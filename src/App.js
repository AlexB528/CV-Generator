  ...
  import PersonalInfoForm from "./components/PersonalInformationForm.js";
  ...
  import PersonalInformationFormatted from './components/PersonalInformationFormatted';
          ...
          return (
              <div class="wrapperLevel1">
                  ...
                  <div class="formattedResumeSection">
                    <FormattedResume skillsInfo={<SkillsFormatted skillForms={this.state.skillFormsFieldData}/>} personalInfo={<PersonalInformationFormatted personalInfoForms={this.state.personalInformationFormsFieldData}/>} descriptionInfo={this.state.description}educationInfo={<EducationFormatted eduForms={this.state.educationFormsFieldData}/>} experienceInfo={<ExperienceFormatted expForms={this.state.experienceFormsFieldData}/>}/>
                  </div>
              </div>
          )
      }
